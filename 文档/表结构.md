...
CREATE TABLE `t_goods_order` (
  ...
  `ChannelId` varchar(24) DEFAULT NULL COMMENT '支付渠道ID- 支付宝，微信',
...
CREATE TABLE `t_pay_order` (
  `PayOrderId` varchar(30) NOT NULL COMMENT '支付流水号- 支付系统生成',
  `MchId` varchar(30) NOT NULL COMMENT '商户ID',
  `MchOrderNo` varchar(30) NOT NULL COMMENT '商户订单号- 业务系统生成的',
  `ChannelId` varchar(24) NOT NULL COMMENT '渠道ID- 支付方式：支付宝，微信',
  `Amount` bigint(20) NOT NULL COMMENT '支付金额,单位分',
  `Currency` varchar(3) NOT NULL DEFAULT 'cny' COMMENT '三位货币代码,人民币:cny',
  `Status` tinyint(6) NOT NULL DEFAULT '0' COMMENT '支付状态,0-流水生成,1-支付中(目前未使用),2-支付成功,3-退款，4-支付失败（超时关闭）',
